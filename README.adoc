...
project provides various common support classes for working with `Resource`s, such as the
...
This deployer SPI has been implemented for several runtime environments. For example, here are the github locations for several implementations:
